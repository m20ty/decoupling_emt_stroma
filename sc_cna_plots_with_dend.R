# bsub -q new-short -R "rusage[mem=64000]" -o sc_cna_plots_with_dend_log.o -e sc_cna_plots_with_dend_log.e Rscript sc_cna_plots_with_dend.R
...
library(cowplot) # 1.0.0 on WEXAC
