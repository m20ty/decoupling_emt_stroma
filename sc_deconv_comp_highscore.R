# bsub -q tirosh -R rusage[mem=128000] -o sc_deconv_comp_highscore.o -e sc_deconv_comp_highscore.e Rscript sc_deconv_comp_highscore.R
...
for(expr_var in c('expression_level', 'expression_level_cc')) {
	...
	cairo_pdf(
		paste0('../data_and_figures/sc_deconv_comp_highscore', gsub('expression_level', '', expr_var), '.pdf'),
		width = 6,
		height = 9,
		onefile = TRUE
	)
...
for(expr_var in c('expression_level', 'expression_level_cc')) {
	...
	cairo_pdf(
		paste0('../data_and_figures/sc_deconv_comp_filtered_highscore', gsub('expression_level', '', expr_var), '.pdf'),
		width = 6,
		height = 9,
		onefile = TRUE
	)
