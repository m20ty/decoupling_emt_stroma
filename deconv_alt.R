...
saveRDS(deconv_data, '../data_and_figures/deconv_alt_data.rds')
saveRDS(deconv_plots, '../data_and_figures/deconv_alt_plots.rds')
...
pdf('../data_and_figures/deconv_alt_figures.pdf', width = 10, height = 12)
for(deconv_plot_ct in deconv_plots) {print(deconv_plot(list(deconv_plot_ct), legends_space = 0.2))}
dev.off()

# Diagnostic figures:
pdf('../data_and_figures/deconv_alt_diagnostics.pdf', width = 10, height = 12)
i <- 1
